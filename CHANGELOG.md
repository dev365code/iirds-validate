...
**Verdicts that moved in 0.7.1 and 0.6.0 without these notes saying so.** A
minor release is meant to name every package shape whose verdict moved, and
these moved unnamed. For a package with nothing else wrong, each takes the
...
- From 0.7.1, in an iiRDS/H 1.3 package: a rendition no document owns (R38),
  and a rendition that selects part of a file rather than referencing the
  whole of it (R39).
