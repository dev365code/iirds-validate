...
for an air-gapped install see [docs/offline-install.md](docs/offline-install.md).
...
[docs/divergences.md](docs/divergences.md). What differs between the two projects is the
