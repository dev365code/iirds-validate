...
> **At a glance** — 199 rules across five editions and three profiles · one
...
manual.iirds   iiRDS 1.3
  ...
  178 rules checked, 21 not applicable to this version/variant (19 for iiRDS/H, 2 for other editions)
$ echo $?
1
```
...
schema     135/135  the metadata graph  +7 of its own
...
157 of 157 catalogued rules, plus 42 of this project's own.
...
- **Reports are ordered for a reader.** What caused the rest comes first, what
  ...
  merely misplaced.
- **Every finding says what to do about it.** All 199 rules carry one imperative
...
- **Every rule has been watched fire.** The suite records which rule ids
  actually produce a finding, and 198 of the 199 have — the remaining one is a
...
**What is not established.** The 42 rules this project invented have no second
