...
> **At a glance** — 205 rules across five editions and three profiles · one
...
schema     135/135  the metadata graph  +13 of its own
...
157 of 157 catalogued rules, plus 48 of this project's own.
...
[`shapes/`](https://github.com/dev365code/iirds-validate/tree/main/shapes) carries the language-neutral encoding: 148 SHACL shapes
...
- **Reports are ordered for a reader.** What caused the rest comes first, what
  ...
  merely misplaced.
- **Every finding says what to do about it.** All 205 rules carry one imperative
...
- **Every rule has been watched fire.** The suite records which rule ids
  actually produce a finding, and 204 of the 205 have — the remaining one is a
...
**What is not established.** The 48 rules this project invented have no second
