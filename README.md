...
> **At a glance** — 192 rules across five editions and three profiles · two
...
manual.iirds   iiRDS 1.3
  ...
  172 rules checked, 20 not applicable to this version/variant
$ echo $?
1
```
...
```console
$ iirdsv rules
container  19/19    the ZIP and its layout  +2 of its own
...
157 of 157 catalogued rules, plus 35 of this project's own.
...
- **Reports are ordered for a reader.** What caused the rest comes first, what
  ...
  merely misplaced.
- **Every finding says what to do about it.** All 192 rules carry one imperative
...
- **Every rule has been watched fire.** The suite records which rule ids
  actually produce a finding, and 191 of the 192 have — the remaining one is a
...
**What is not established.** The 35 rules this project invented have no second
