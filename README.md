...
> **At a glance** — 197 rules across five editions and three profiles · one
...
manual.iirds   iiRDS 1.3
  ...
  176 rules checked, 21 not applicable to this version/variant (19 for iiRDS/H, 2 for other editions)
$ echo $?
1
```
...
for an air-gapped install see [docs/offline-install.md](https://github.com/dev365code/iirds-validate/blob/main/docs/offline-install.md).
...
already there would satisfy a plain install. [CHANGELOG.md](https://github.com/dev365code/iirds-validate/blob/main/CHANGELOG.md) says
...
see [`docs/offline-install.md`](https://github.com/dev365code/iirds-validate/blob/main/docs/offline-install.md).
...
writes packages is described [below](#reading-and-writing-packages-from-python).
...
with evidence, in [docs/divergences.md](https://github.com/dev365code/iirds-validate/blob/main/docs/divergences.md).
...
157 of 157 catalogued rules, plus 40 of this project's own.
...
[`shapes/`](https://github.com/dev365code/iirds-validate/tree/main/shapes) carries the language-neutral encoding: 142 SHACL shapes
...
closing check that no shape sits the suite out — and [`shapes/MANIFEST.json`](https://github.com/dev365code/iirds-validate/blob/main/shapes/MANIFEST.json) accounts for
...
[`shapes/README.md`](https://github.com/dev365code/iirds-validate/blob/main/shapes/README.md) has the three conventions that matter
...
[docs/scope.md](https://github.com/dev365code/iirds-validate/blob/main/docs/scope.md) is the map: what this is, what it deliberately is
...
- **Cross-validation, against a corpus that is in the repository.** The
  ...
  [docs/divergences.md](https://github.com/dev365code/iirds-validate/blob/main/docs/divergences.md).
- **Reports are ordered for a reader.** What caused the rest comes first, what
  ...
  merely misplaced.
- **Every finding says what to do about it.** All 197 rules carry one imperative
...
- **Every rule has been watched fire.** The suite records which rule ids
  actually produce a finding, and 196 of the 197 have — the remaining one is a
...
**What is not established.** The 40 rules this project invented have no second
...
[docs/divergences.md](https://github.com/dev365code/iirds-validate/blob/main/docs/divergences.md) records where this project is
...
catalogue. See [CONTRIBUTING.md](https://github.com/dev365code/iirds-validate/blob/main/CONTRIBUTING.md) — including the DCO: every
...
[docs/divergences.md](https://github.com/dev365code/iirds-validate/blob/main/docs/divergences.md). What differs between the two projects is the
