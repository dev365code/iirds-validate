...
> **At a glance** — 207 rules across five editions and three profiles · one
...
[`shapes/`](https://github.com/dev365code/iirds-validate/tree/main/shapes) carries the language-neutral encoding: 149 SHACL shapes
...
- **Every rule has been watched fire.** The suite records which rule ids
  actually produce a finding, and 206 of the 207 have — the remaining one is a
