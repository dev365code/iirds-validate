...
|---|---|---|---|
| Rule ids, priorities, spec links, rule wording (`src/iirds_validate/data/rule-catalog.json`) | [plusmeta/iirds-validation-tool](https://github.com/plusmeta/iirds-validation-tool) | MIT | Reformatted to JSON; wording unchanged |
