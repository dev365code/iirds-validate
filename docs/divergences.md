...
A document marked UTF-16 or UTF-32 by its byte order mark or its first bytes
is read as such whatever it declares; XML makes a declaration that contradicts the mark
