...
| **M96.1–3, M97.1–2, M49, M76** | Declared applicable from 1.0 while naming vocabulary that arrives in 1.2 (external classification) or 1.1 (identity types, protective equipment). They ran, matched nothing, reported clean; what was wrong was the claim. Seven version arrays corrected in all — the last two found the day the inventory gained the official 1.0 schemas. | comparing each rule's terms against the Consortium's published schema of each edition |
