...
1. **Coverage of the standard is 171 of 280.** 136 of the 171 are held by a
   ...
   names the 136 claims a package stands behind, and names the other 35 in a
   ...
   **A claim says a violation is reported. It does not say the package
   fails.** Nine of the 171 are appendix B's rules about iiRDS XHTML5 content,
