...
1. **Coverage of the standard is 167 of 280.** 132 of the 167 are held by a
   ...
   names the 132 claims a package stands behind, and names the other 35 in a
   ...
   **A claim says a violation is reported. It does not say the package
   fails.** Nine of the 167 are appendix B's rules about iiRDS XHTML5 content,
