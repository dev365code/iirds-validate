...
1. **Coverage of the standard is 164 of 280.** 129 of the 164 are held by a
   ...
   names the 96 claims a package stands behind, and names the other 35 in a
   ...
   **A claim says a violation is reported. It does not say the package
   fails.** Nine of the 164 are appendix B's rules about iiRDS XHTML5 content,
