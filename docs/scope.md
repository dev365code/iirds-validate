...
1. **Coverage of the standard is 170 of 280.** 135 of the 170 are held by a
   ...
   names the 135 claims a package stands behind, and names the other 35 in a
   ...
   **A claim says a violation is reported. It does not say the package
   fails.** Nine of the 170 are appendix B's rules about iiRDS XHTML5 content,
