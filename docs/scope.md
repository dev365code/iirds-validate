...
1. **Coverage of the standard is 77 of 280.** 26 of the 77 are held by a
   ...
   names the 26 claims a package stands behind, and names the other 51 in a
   ...
   **A claim says a violation is reported. It does not say the package
   fails.** Eight of the 77 are appendix B's rules about iiRDS XHTML5 content,
