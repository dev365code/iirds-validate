...
1. **Coverage of the standard is 71 of 280.** 20 of the 71 are held by a
   ...
   names the 20 claims a package stands behind, and names the other 51 in a
   ...
   **A claim says a violation is reported. It does not say the package
   fails.** Eight of the 71 are appendix B's rules about iiRDS XHTML5 content,
