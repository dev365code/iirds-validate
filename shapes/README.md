...
73 of the 242 rules have no shape, in four honest categories,
each listed with its reason in `MANIFEST.json`:

- **61 not expressible** — 61 of the 242 rules are about ZIP bytes, content
...
Every emitted shape is **differentially tested against the 242-rule Python
