...
61 of the 230 rules have no shape, in four honest categories,
each listed with its reason in `MANIFEST.json`:

- **49 not expressible** — 49 of the 230 rules are about ZIP bytes, content
...
Every emitted shape is **differentially tested against the 230-rule Python
