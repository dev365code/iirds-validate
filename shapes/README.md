...
63 of the 232 rules have no shape, in four honest categories,
each listed with its reason in `MANIFEST.json`:

- **51 not expressible** — 51 of the 232 rules are about ZIP bytes, content
...
Every emitted shape is **differentially tested against the 232-rule Python
