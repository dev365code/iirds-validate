...
def test_a_rule_that_reads_an_entry_stands_down_rather_than_raising(tmp_path):
    ...
    # This release line's report carries a count rather than a list of the
    # rules that ran, so the rule standing down is held to by the absence of
    # the finding a raise produces, which is what the reader met.
