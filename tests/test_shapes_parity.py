...
#: the adversarial review hid seven files\' divergence from us. Any change to
...
# three of them exactly the shapes the adversarial review proved wrong and
...
# must be one to the shapes too. The adversarial review found the old shapes
...
# ---------------------------------------------------------------------------
# 6c. The adversarial review's disagreement archetypes, kept as fixtures.
#
...
# the second adversarial pass found the *classes* those instances belonged to
...
# about a shape that never fires. The adversarial review demonstrated exactly
